...
5. ✅ Обновить SIMPLY_ROADMAP.md (отметить выполненные задачи)
...
**Пример:**
- ❌ Неправильно: Писать список AI tools в README, CLAUDE.md и docs/ai-capabilities.md
- ✅ Правильно: Написать в docs/ai-capabilities.md, остальные файлы ссылаются на него
...
- AI возможности → `docs/ai-capabilities.md`
...
│                                     • Ссылки на docs/
│
├── SIMPLY_ROADMAP.md ─────────────► ПЛАН РАЗРАБОТКИ
│                                     • Этапы
...
└── docs/ ──────────────────────────► ДЕТАЛЬНАЯ ДОКУМЕНТАЦИЯ
    ...
    │                                 • Схема потока данных
    │
    ├── ai-capabilities.md ─────────► ВОЗМОЖНОСТИ AI
    │                                 • Доступные модели
    │                                 • AI Tools (Brave Search, etc.)
    │                                 • Streaming, artifacts
    │
...
**Что НЕ ДОЛЖНО быть:**
- ❌ Детальная установка (→ docs/setup.md)
- ❌ Описание AI capabilities (→ docs/ai-capabilities.md)
...
### docs/ai-capabilities.md ⭐ КРИТИЧЕСКИ ВАЖНЫЙ

> **🚨 ОБЯЗАТЕЛЬНО:** При добавлении ЛЮБОЙ новой возможности AI-агентам
> (новый tool, vision, OCR, search, etc.) — ОБНОВИ ЭТОТ ДОКУМЕНТ!

**Источник правды для:**
- Доступные AI модели (Gemini, etc.)
- AI Tools и их описание (Web Search, Read Document, etc.)
- Vision/OCR возможности (Image OCR, PDF OCR)
- Возможности streaming
- Artifacts и code execution
- Роли пользователей и их промпты
- Форматы файлов и лимиты

**Когда обновлять:**
- ✅ Добавил новый AI tool → опиши его в ai-capabilities.md
- ✅ Изменил существующий tool → обнови описание
- ✅ Добавил поддержку нового формата файлов → добавь в список
- ✅ Изменил лимиты (размер файла, таймауты) → обнови значения
- ✅ Добавил новую AI модель → добавь в список моделей

**Формат описания нового tool:**
```markdown
#### Название Tool
- **Описание:** Что делает
- **Возможности:** Список возможностей
- **Требования:** Переменные окружения (если есть)
- **Файл:** Ссылка на файл реализации
...
**1. Обновил код?**
- [ ] Обновил SIMPLY_ROADMAP.md (отметь [X] выполненные задачи)
...
- [ ] Обнови docs/ai-capabilities.md (если новый AI tool)
...
- [ ] **ОБЯЗАТЕЛЬНО** обнови docs/ai-capabilities.md
- [ ] Добавь описание по шаблону (см. раздел docs/ai-capabilities.md)
...
| AI модели и tools | docs/ai-capabilities.md |
...
| План развития | SIMPLY_ROADMAP.md |
