...
**Задачи:**
- [x] Финальное мануальное тестирование (полный flow) — подтверждено в сессиях 3-4
- [x] Перенести CHANGELOG.md → главный CHANGELOG.md
- [x] Обновить SIMPLY_STATUS.md
- [x] Обновить CLAUDE.md (добавить Context Management секцию)
- [x] Обновить package.json (3.17.0 → 3.18.0)
- [x] Обновить docs/ai-chats-map.md (добавить snapshot tool)
- [x] Переместить папку `specs/TZ_C1_5_ContextManagement/` → `_archive/TZ_C1_5_ContextManagement/`

**Валидация финальная:**
- [x] `npm run build` — успешен
- [x] Все функции работают в браузере
- [x] Документация актуальна
- [x] Версия обновлена везде (package.json, STATUS, CHANGELOG)
