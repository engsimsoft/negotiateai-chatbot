...
**Задачи:**
- [x] Финальное мануальное тестирование (полный flow)
- [x] SQL-проверка БД (таблицы, связи)
- [x] Перенести CHANGELOG.md → главный CHANGELOG.md
- [x] Обновить SIMPLY_STATUS.md
- [x] Обновить CLAUDE.md (добавить TaskChat в структуру кода)
- [x] Обновить package.json (3.15.0 → 3.16.0)
- [x] Переместить папку `specs/TZ_C1_ExpertTaskChat/` → `_archive/TZ_C1_ExpertTaskChat/`

**Валидация финальная:**
- [x] `npm run build` — успешен
- [x] Все функции работают в браузере
- [x] Документация актуальна
- [x] Версия обновлена (package.json, SIMPLY_STATUS, CHANGELOG)
