...
const tools = [
  { id: 1, name: "Диктофон", emoji: "🎙️", desc: "Запись → текст" },
  { id: 2, name: "Исследование", emoji: "🔍", desc: "Глубокий анализ темы" },
  { id: 3, name: "Брифинг", emoji: "☀️", desc: "Утренний дайджест" },
];
    ...
    <div style={{ 
      ...
      <main style={{ maxWidth: 880, margin: "0 auto", padding: "40px 24px 80px" }}>
        ...
        <section style={{ marginBottom: 40 }}>
          ...
          {/* Custom first — they're more important to returning user */}
