...
**Задачи:**
- [x] 5.1 Удалить пакет `geist` из `package.json` + `npm install`
- [x] 5.2 Финальный `npm run build` (clean: rm -rf .next)
- [ ] 5.3 Финальное мануальное тестирование (пользователь): все страницы light + dark
- [x] 5.4 Обновить главный `CHANGELOG.md`
- [x] 5.5 Обновить `SIMPLY_STATUS.md`
- [x] 5.6 Обновить `package.json` (версия 3.19.0)
- [x] 5.7 Переместить папку в `_archive/`
