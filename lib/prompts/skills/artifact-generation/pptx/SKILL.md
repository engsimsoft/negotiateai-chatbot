---
name: artifact-pptx
description: Generates PowerPoint slide deck as a JSON array with title/bullets/content/quote/end slide types. Loaded deterministically via taskId artifact:pptx.
---
