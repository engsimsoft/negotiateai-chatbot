...
**Проект:** Simply | **Версия:** 3.78.0 | **Статус:** Active development
...
- Маршрутизация модели: текст → MiniMax M2.7, фото/PDF → Gemini 3 Flash Preview, «Думать» → Sonnet. **Детали:** [docs/ai-minimax.md](docs/ai-minimax.md)
