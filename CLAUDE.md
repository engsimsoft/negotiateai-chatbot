...
**Проект:** Simply | **Версия:** 3.41.0 | **Статус:** Active development
...
**Briefing UI (v3.28.0 — Landing, v3.30.0 — Onboarding, v3.32.0 — Issue Page, v3.33.0 — Progress, v3.39.0 — SavedTopics, v3.40.0 — SimplyNews, v3.41.0 — SidebarRedesign):**
...
- `components/briefing/briefing-page-client.tsx` — Клиентская обёртка /briefing (управление генерацией, savedTopics state, headline extraction при сохранении, SimplyData state, h-svh fixed layout)
