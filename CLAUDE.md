...
**Проект:** Simply | **Версия:** 3.63.0 | **Статус:** Active development
...
- `lib/ai/usage-utils.ts` — Unified usage logging: `extractUsageFields()` + `logUsage()` (fire-and-forget). chatMode конвенция: `service:*|professor:*|clerk:*|briefing:*|podcast:*|tool:*|meeting:*|util:*|project:*` ← v3.63.0
