...
# **ЧИТАЙ ТЕХЗАДАНИЕ ПЕРВЫМ ДЕЛОМ!!!**

**⚠️ ЭТО КРИТИЧЕСКИ ВАЖНО!** Без чтения техзадания ты потратишь часы на неправильную реализацию!

### Порядок действий (СТРОГО):

1. **📖 ЧИТАЙ ТЕХЗАДАНИЕ:** `Техзадание /negotiateai-tech-spec.md` - **ПЕРВЫМ ДЕЛОМ!**
2. **📋 Прочитай структуру проекта:** [README.md](README.md)
3. **📝 Изучи правила документации:** [DOCUMENTATION_GUIDE.md](DOCUMENTATION_GUIDE.md)
4. **🎯 Следуй принципу SSOT** - Single Source of Truth (никаких дублей!)

### ⚠️ ВАЖНО: Что уже решено в техзадании

В техзадании **УЖЕ УКАЗАН** готовый подход - **НЕ ПРИДУМЫВАЙ СВОЮ РЕАЛИЗАЦИЮ!**

✅ **Использовать Vercel AI Chatbot Template** (НЕ писать с нуля!)
✅ **Использовать Anthropic API напрямую** (НЕ через OpenRouter!)
✅ **Использовать официальный @anthropic-ai/sdk**
✅ **Документы читать БЕЗ конвертации** (Claude читает DOCX/PDF напрямую)
✅ **История чатов, auth, database** - всё это нужно (часть template)

**🚫 НЕ ПИШИ КОД С НУЛЯ!** Бери готовый template и адаптируй!
