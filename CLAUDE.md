...
**Проект:** Simply | **Версия:** 3.29.0 | **Статус:** Active development
...
- `lib/prompts/briefing/` — Промпт аналитика брифинга (briefing-analyst.md)
