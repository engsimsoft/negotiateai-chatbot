...
**Проект:** Simply | **Версия:** 3.74.0 | **Статус:** Active development
...
- `lib/prompts/chat/simply-chat.md` — System prompt Simply Chat (роль, навигация, быстрые команды)
