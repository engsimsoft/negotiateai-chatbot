...
**Проект:** Simply | **Версия:** 3.72.0 | **Статус:** Active development
...
- `lib/ai/memory/extract.ts` — extractFactsFromMessages (Claude Sonnet + generateObject), extractAndStoreFacts (extract → embed → dedup → upsert), мини-консолидация триггер ← v3.72.0
