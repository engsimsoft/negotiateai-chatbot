...
**Context Window Management (v3.18.0 — ТЗ-C1.5, v3.73.0 — ТЗ-RAG3 Compaction):**
...
- `lib/ai/context-limits.ts` — Конфиг snapshot (CONTEXT_BUDGET, SNAPSHOT_THRESHOLD, FALLBACK_MESSAGE_PAIRS) — только для Haiku
