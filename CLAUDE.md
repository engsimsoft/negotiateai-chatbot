...
**Проект:** Simply | **Версия:** 3.33.1 | **Статус:** Active development
...
- `lib/ai/tools/fetch-page.ts` — Shared utility для чтения веб-страниц ← v3.29.0
