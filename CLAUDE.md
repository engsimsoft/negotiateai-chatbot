...
**Проект:** Simply | **Версия:** 3.77.0 | **Статус:** Active development
...
**Simply Chat (v3.77.0 — ТЗ-MinimaxCleanup):**
...
- Маршрутизация модели: текст → MiniMax M2.7, фото/PDF → Gemini 3 Flash Preview, «Думать» → Sonnet
