...
/**
 * Рендерер для Markdown файлов (.md)
 *
 * Особенности:
 * - Fetch содержимого файла
 * - Рендеринг через shared MarkdownViewer (GFM, prose стили)
 * - Ограничение 500KB
 * - Loading/Error состояния
 */
export function MarkdownRenderer({ file, onLoad, onError }: FileRendererProps) {
