...
Пошаговое руководство по установке и настройке проекта Simply.
...
### 5.3 Создание тестовых пользователей

Запусти seed скрипт для создания 2 предустановленных пользователей:
...
**Примечание:**
- Это тестовые пользователи для разработки
- После первого входа обязательно смени пароли
- Для production БД используй: `source .env.production && npm run db:seed`
...
Бот должен ответить согласно выбранному агенту
...
**Ожидаемое поведение:**
- AI-агент отвечает согласно своему промпту
...
3. **Тестируй систему** - используй предустановленных пользователей (см. Шаг 5.3)
