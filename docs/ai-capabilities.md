...
**Статус:** ✅ Актуально для Этапа 3 (завершен)

---

## 📖 О документе

Этот документ описывает все возможности и инструменты, доступные AI-агентам в приложении **Family AI Assistant**. В версии 2.1.0 реализована полная система из 8 специализированных агентов с автоматическим выбором AI моделей.

---

## 🤖 Специализированные AI-агенты

**Версия:** 2.1.0 (Этап 3 завершен)

В приложении доступны 8 специализированных AI-агентов с уникальными промптами и поведением. Каждый агент автоматически использует оптимальную AI модель (Gemini 3 Pro или Gemini 2.5 Flash) в зависимости от типа задач.
