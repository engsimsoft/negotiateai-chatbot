...
Этот документ описывает возможности и инструменты AI-агентов в **Simply**. Система включает 9 специализированных агентов с автоматическим выбором AI моделей и систему артефактов (текст, презентации).

**Примечание:** При переходе к Этапу 1 (ТЗ-1) часть агентов будет удалена, а архитектура мигрирует в БД.
...
**Обновлено:** 2026-01-28 (Simply rebrand v2.2.0)
