...
|------|----------|--------|--------|-------------|
| **RAG-0** | Инфраструктура | 3.70.0 | 🔄 В работе | — |
| **RAG-1** | MIND Extract + Retrieve | 3.71.0 | ⬜ Не начат | RAG-0 |
| **RAG-2** | MIND Consolidation + Profile + UI | 3.72.0 | ⬜ Не начат | RAG-1 |
| **RAG-3** | Compaction (бесконечный чат) | 3.73.0 | ⬜ Не начат | Независим (можно параллельно с RAG-1/2) |
