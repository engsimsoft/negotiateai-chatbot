...
> **🗄️ АРХИВИРОВАН 2026-04-14 в ТЗ-XAI-1.** Решение: эмпирический тест отвечал на неправильный вопрос. Защита контекста (sliding window + Extract-on-compression) остаётся основой независимо от провайдерского окна — вечный чат заполнит любое, модели деградируют на 30-50% заявленного (Lost in the Middle). Привязка `SIMPLY_CONTEXT_LIMIT` к размеру провайдерского окна — антипаттерн. Текущие 256K/128K в каталоге = заведомо безопасный нижний край для рабочего бюджета качества (140K). Подробно: [specs/Simply_xAI/SIMPLY_XAI_NOTES.md](../../Simply_xAI/SIMPLY_XAI_NOTES.md) (запись 2026-04-14 «Коррекция архитектурного допущения»).

**Импакт:** low · **Оценка:** 0.5 сессии · **Создано:** 2026-04-13 · **Закрыт:** 2026-04-14
